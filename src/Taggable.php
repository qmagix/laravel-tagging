...
namespace Qmagix\Tagging;

use Qmagix\Tagging\Contracts\TaggingUtility;
use Qmagix\Tagging\Events\TagAdded;
use Qmagix\Tagging\Events\TagRemoved;
use Qmagix\Tagging\Model\Tagged;
...
trait Taggable
{
	/** @var \Qmagix\Tagging\Contracts\TaggingUtility **/
	...
	{
		return $this->morphMany(config('tagging.tagged_model', 'Qmagix\Tagging\Model\Tagged'), 'taggable')->with('tag');
	}
